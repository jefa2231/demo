...
<body class="bg-slate-950 text-slate-100 min-h-screen">
  ...
  <div class="mx-auto max-w-6xl px-4 py-4 space-y-4">
    <header class="rounded-2xl border border-white/10 bg-slate-900/80 p-3 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
      <div>
      ...
      <nav class="flex flex-wrap items-center gap-2 text-xs">
        <a class="rounded-lg px-2 py-1 bg-white/10 text-slate-200 hover:bg-white/20" href="<?= e(local_url('/')) ?>" target="_blank">Lihat Site</a>
